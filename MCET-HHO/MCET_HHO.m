...
% Erick Rodr铆guez-Esparza, Laura A Zanella-Calzada, Diego Oliva, Ali Asghar Heidari, 
% Daniel Zaldivar, Marco P茅rez-Cisneros, Loke Kok Foong
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function seg=MCET_HHO(I)

% I=imread('.jpg');    % Load image
...
for i=1:L 
    probI(i)=h(i)/Nt;%每个灰度等级的概率
end

%% Initial data of the HHO algorithm
nVar=5;                                 % Number of thresholds (Th)     
